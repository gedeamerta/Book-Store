    ...
    <div class="shadow mt-5">
        <div class="row">
            ...
            <div class="col-md-7 m-3">
                ...
                <p class="text-muted mt-2 mb-2 <?= strlen($data['book_single']['sipnosis']) < 500 ? '' : 'description substr'?>">
                    <?= $data['book_single']['sipnosis']; ?>
                </p><?php if(strlen($data['book_single']['sipnosis']) > 500): ?><a href="#" class="read-more">Read More</a>
                <?php endif;?>
