        ...
        <div class="col-md">
            ...
            <?php foreach ($data['category_data'] as $c_d) : ?>
                <div class="shadow mt-5">
                    <div class="row">
                        <div class="col-md">
                            <img src="<?= baseurl . '/assets/img/' . $c_d['image'] ?>" alt="" srcset="">
                        </div>
                        <div class="col-md-7 m-3">
                            <h1 class="card-title"><?= $c_d['judul_buku'] ?></h1>
                            ...
                            <p class="text-secondary m-0">Category : <?= $c_d['category'] ?></p>

                            <h2 class="h3 mt-3">Sinopsis</h2>
                            <p class="text-muted mt-2 mb-2"><?= $c_d['sipnosis'] ?></p>
                            <footer class="blockquote-footer mb-2">Author : <i><?= $c_d['fullname'] ?></i></footer>
                            <a href="<?= baseurl; ?>/dashboard/bookData/<?= $c_d['id']; ?>" class="btn btn-info">Cek
