...
<div class="container-mine">
    <div class="decor back-biru">
        ...
        <button class="btn btn-info" style="font-size: 20px;" type="button" data-toggle="modal"
            data-target="#register">Daftar
    ...
    <div class="uk-animation" tabindex="0">
        <div class="uk-animation-scale-up">
            <img style="background-image: no-repeat; background-size: cover;"
                src="<?= baseurl; ?>/assets/img/background-index.png" alt="" srcset="">
        </div>
    </div>
...
<div class="container-fluid">
    <div class="text-up">
        <div class="row">
            ...
            <div class="col-md-6">
                <button onclick="window.location.href='<?= baseurl; ?>/home/book'" class="float-right" type="submit">
                    Lihat Semua </button>
            </div>
        </div>
    </div>
                ...
                <div class="card-deck">
                    <div class="card" uk-scrollspy="cls:uk-animation-slide-left; repeat: true" style="width:100%;">
                        ...
                        <div class="card-body">
                            ...
                            <footer class="blockquote-footer mb-3">Pengarang <cite
                                    title="Source Title"><?= $book['fullname'] ?></cite></footer>
                            </blockquote>
        ...
        <div class="col-md-4">
            <div uk-scrollspy="cls:uk-animation-slide-top; repeat: true">
                <div class="card-body card rounded mb-5">
                    ...
                    <button data-toggle="modal" data-target="#loginModal" class="btn btn-info mt-5 mb-5"
        ...
        <div class="col-md-4">
            <div uk-scrollspy="cls:uk-animation-slide-bottom; repeat: true">
                <div class="card card-body rounded mb-5">
                    ...
                    <button class="btn btn-info mt-5 mb-5" data-toggle="modal" data-target="#loginModal"
                        type="submit">Beli Sekarang
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-right-short"
                            fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <li>
                    <div class="uk-panel col-md p-5 text-center">
                        ...
                        <div class="card-body">
                            ...
                            <footer class="blockquote-footer mb-3 text-light text-center">Founder <cite
                                    title="Source Title">Radio 19</cite></footer>
                            <h4 class="text-center text-light m-2">Lorem ipsum dolor sit amet consectetur adipisicing
                                elit. Veritatis eius officia consequatur ab sequi aperiam, molestias non eum
                                dignissimos, accusamus corporis necessitatibus rem minima doloremque nihil nesciunt
                                voluptates expedita saepe.</h4>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="uk-panel p-5 text-center">
                        ...
                        <div class="card-body">
                            ...
                            <footer class="blockquote-footer mb-3 text-center text-light">CEO <cite
                                    title="Source Title">Gymnastics CPC</cite></footer>
                            <h4 class="card-text text-center text-light m-2">Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Veritatis eius officia consequatur ab sequi aperiam, molestias non eum
                                dignissimos, accusamus corporis necessitatibus rem minima doloremque nihil nesciunt
                                voluptates expedita saepe.</h4>
                ...
                <li>
                    <div class="uk-panel p-5 text-center">
                        ...
                        <div class="card-body">
                            ...
                            <footer class="blockquote-footer mb-3 text-center text-light">Developer <cite
                                    title="Source Title">Gojek</cite></footer>
                            <h4 class="card-text text-center text-light m-2">Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Veritatis eius officia consequatur ab sequi aperiam, molestias non eum
                                dignissimos, accusamus corporis necessitatibus rem minima doloremque nihil nesciunt
                                voluptates expedita saepe.</h4>
                ...
                <li>
                    <div class="uk-panel p-5 text-center">
                        ...
                        <div class="card-body">
                            ...
                            <footer class="blockquote-footer mb-3 text-center text-light">Manager <cite
                                    title="Source Title">PT Astra Motor</cite></footer>
                            <h4 class="card-text text-center text-light m-2">Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Veritatis eius officia consequatur ab sequi aperiam, molestias non eum
                                dignissimos, accusamus corporis necessitatibus rem minima doloremque nihil nesciunt
                                voluptates expedita saepe.</h4>
