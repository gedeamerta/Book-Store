...
<div class="container-mine">
    <div class="decor back-biru">
        <h1 class="mb-3">Mulai Perbanyak Minat Membaca</h1>
        <h1 class="h1-black mb-3">Baca , Pahami, Tingkatkan</h1>
        <h3>Daftar Gratis !</h1>
            <button class="btn btn-info" style="font-size: 20px;" type="submit">Daftar 
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-right-short" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8.146 4.646a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.793 8 8.146 5.354a.5.5 0 0 1 0-.708z" />
                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5H11a.5.5 0 0 1 0 1H4.5A.5.5 0 0 1 4 8z" />
                </svg></button>
    </div>
    <img style="background-image: no-repeat; background-size: cover; overflow: hidden;" src="<?= baseurl; ?>/assets/img/background-index.png" alt="" srcset="">
</div>
<!-- container 1 end -->
            ...
            <div class="col-md-4 mb-4">
                <div class="card-deck">
                    <div class="card" uk-scrollspy="cls:uk-animation-slide-left; repeat: true" style="width:100%;">
                        ...
                        <div class="card-body">
                            <h2 class="card-title">Filosofi Teras</h2>
                            ...
                            <a href="#" class="btn btn-info">Cek Lebih Lanjut</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card-deck">
                    <div class="card" uk-scrollspy="cls:uk-animation-slide-left; repeat: true" style="width:100%;">
                        ...
                        <div class="card-body">
                            <h2 class="card-title">Filosofi Teras</h2>
                            <p class="card-text mb-2"><svg width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.5 1.61804L13.6064 8.10081L13.7186 8.4463H14.0819H20.8983L15.3837 12.4529L15.0898 12.6664L15.2021 13.0119L17.3085 19.4947L11.7939 15.4881L11.5 15.2746L11.2061 15.4881L5.69153 19.4947L7.79791 13.0119L7.91017 12.6664L7.61627 12.4529L2.10169 8.4463H8.91809H9.28136L9.39362 8.10081L11.5 1.61804Z" fill="#FFE601" stroke="#FFE601" />
                                </svg>
    ...
    <div uk-slider="center: true">
        <div class="uk-position-relative uk-visible-toggle uk-light mb-5" tabindex="-1">
            ...
            <ul class="uk-slider-items uk-child-width-1-2@s uk-grid">
                <li>
                    <div class="uk-panel card m-2">
                        <img src="<?= baseurl; ?>/assets/img/banner.jpg" alt="">
                        <div class="card-body">
                            <h1 class="card-title text-dark text-center">Gede Amerta</h1>
                            <footer class="blockquote-footer mb-3 text-center">Someone famous in <cite title="Source Title">Source Title</cite></footer>
                            <h4 class="card-text text-center text-dark m-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis eius officia consequatur ab sequi aperiam, molestias non eum dignissimos, accusamus corporis necessitatibus rem minima doloremque nihil nesciunt voluptates expedita saepe.</h4>
