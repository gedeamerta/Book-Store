...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Finger+Paint&family=Fira+Sans:wght@500&display=swap"
        rel="stylesheet">
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto p-2">
                    <li class="nav-item">
                        <a class="nav-link <?= $data['set_active'] == 'index' ? 'active' : '' ?>"
                            href="<?= $data['validate'] == 'anonim' ? baseurl . '/home' : (($data['validate'] == 'user') ? baseurl . '/dashboard' : '') ?>">
                            Home <span class=" sr-only">(current)</span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link 
                <?= $data['set_active'] == 'book' ? 'active' : '' ?>"
                            href="<?= $data['validate'] == 'anonim' ? baseurl . '/home/book' : (($data['validate'] == 'user') ? baseurl . '/dashboard/book' : '') ?>">Buku</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link 
                        <?= $data['set_active'] == 'payment' ? 'active' : '' ?>"
                            href="<?= $data['validate'] == 'user' ? baseurl . '/dashboard/pay' : ''?>">Payment</a>
                    </li>
                    <?php endif; ?>
                </ul>
                <!-- navbar end -->
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <button type="button" data-toggle="modal" data-target="#loginModal"
                            class="btn btn-info mr-3 font-weight-bold">Masuk</button>
                    ...
                    <li>
                        <button type="button" data-toggle="modal" data-target="#register"
                            class="btn btn-dark mr-3 font-weight-bold">Daftar</button>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle ml-5" href="#" id="navbarDropdownMenuLink" role="button"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?= baseurl; ?>/dashboard/bookUser">Buku Pilihan Anda <i
                                    class="fas fa-book-reader"></i></a>
                            <?php if($data['premium']['id'] == $_SESSION['id'] && $data['premium']['status_package'] == 2) : ?>
                            <?php else :  ?>
                            <a class="dropdown-item" data-toggle="modal" data-target="#package">Upgrade to premium <i
                                    class="far fa-gem"></i></a>
                            <?php endif; ?>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" data-toggle="modal" data-target="#logoutModaluser">Log out <i
    ...
    <div class="modal fade" id="package" tabindex="1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-dark" id="exampleModalLabel">Ingin membeli Package Premium <i
                            class="far fa-gem"></i> ?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Sudah yakin ingin membeli paket premium ? Dengan paket premium, anda akan lebih leluasa mengakses
                    fitur fitur kami.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    <button onclick="window.location.href='<?= baseurl; ?>/dashboard/package/<?= $_SESSION['id']; ?>'"
