...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-1 text-gray-800">List Delete Request Book</h1>
    <p class="mb-4">This will delete author book</p>
            ...
            <div class="col-lg-6">
                <div class="card position-relative mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?= baseurl; ?>/admin/deleteBook/<?= $dataBook['id_book'] ?>" class="btn btn-danger mt-3">Delete</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
